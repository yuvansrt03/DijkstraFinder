      ...
      <div className="flex flex-row w-auto mt-2 justify-evenly">
        <button
          ...
          className={`px-3 py-1 my-2 text-white bg-green-400 ${
            header === "start" && "bg-transparent cursor-default h-0"
          } ${header === "end" && "bg-transparent cursor-default h-0"}`}
        >
          Reset
        </button>
      </div>
      <div>
        <div className="grid h-full gap-0 cursor-pointer grid-cols-100">
          {List}
        </div>
      </div>
